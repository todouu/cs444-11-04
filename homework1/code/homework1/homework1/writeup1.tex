...
\begin{tabular}{ |c|c|c|c|c|c| }
   ...
   April 18th & All & 11:00am & 12:00pm & 1 hour & Set up the folder to contain the work we will be doing in this project. Started on the writeup by setting it up and completing the write up for the log of commands. Got the github to work. Read through the concerency assignment. \\  
   April 19th & All & 2:30pm & 8:30pm & 5 hours & Begain the concerency assignment. Created the psudeo code for the exersise and discused how we wanted to go about completing the exersise. Created the c file and made our struct and all of our functions. Also worked on the write up to create the work log and begain to asnwer the questions regarding the concerency exercise.     
\end{tabular}
\end{center}
