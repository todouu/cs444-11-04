...
int my_rand(int cases)
{
        ...
        switch (cases) {
                ...
                case 2:
                        ...
                        // consumer wait
                        if (check_method() == 0) {
                                int x = ((get_random_32(&arand) % 7) + 2);
                                printf("The consumer wait is: %d\n", x);
                        } else {
                ...
                case 3:
                        ...
                        // prodocuer wait
                        if (check_method() == 0) {
                               int x = ((get_random_32(&arand) % 4) + 3);
                                printf("The producer wait time is: %d\n", x);
                        } else {
...
int main (int argc, char **argv) 
{
        ...
        while (work_count != MaxJob - 1) {
                ...
                for (i = 0; i < 2; i++) {
						...
						printf("loop delete count: %d \n", work_count);
                }
                printf("2. Total count is %d \n", work_count);
        }
